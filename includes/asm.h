...
void AsmCall(uint address, Z80_registers* regs, register_usage inRegistersDetail,
		register_usage outRegistersDetail) __sdcccall(0);

//* Execute a DOS function call,
//  it is equivalent to invoking address 5 with function number in register C.
void DosCall(byte function, Z80_registers* regs, register_usage inRegistersDetail,
...
void UnapiCall(unapi_code_block* codeBlock, byte functionNumber, Z80_registers* registers,
		register_usage inRegistersDetail, register_usage outRegistersDetail);
